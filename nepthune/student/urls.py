...
urlpatterns = [
    ...
    path('modif-infos-persos.html', views.infos_perso, name='modif-infos'),
    ...
    path('faq.html', views.faq_view, name='foire-aux-questions'),
    path('tests.html', views.base, name='tests'),
    #path("create", views)
